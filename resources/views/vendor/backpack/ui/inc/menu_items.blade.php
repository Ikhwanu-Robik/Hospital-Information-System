...
<x-backpack::menu-dropdown title="Medical Records" icons="la la-group">
    <x-backpack::menu-dropdown-item title="Medical records" icon="la la-question" :link="backpack_url('medical-record')" />
    <x-backpack::menu-dropdown-item title="Prescription medicines" icon="la la-question" :link="backpack_url('prescription-medicine')" />
    <x-backpack::menu-dropdown-item title="Prescription records" icon="la la-question" :link="backpack_url('prescription-record')" />
</x-backpack::menu-dropdown>
<x-backpack::menu-dropdown title="Medicines" icons="la la-group">
    ...
    <x-backpack::menu-dropdown-item title="Medicine forms" icon="la la-question" :link="backpack_url('medicine-form')" />
    <x-backpack::menu-dropdown-item title="Medicine routes" icon="la la-question" :link="backpack_url('medicine-route')" />
</x-backpack::menu-dropdown>
